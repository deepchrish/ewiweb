            ...
            <div class="row">
                <div class="col-md-5 mt-4">
                    ...
                    <div class="about-header-text pt-2">
                        <p>Advice and answers from the Everything With Ink Team</p>
                ...
                <div class="col-md-7 mt-4">
                    ...
                    <div class="cus-right-img">
                        <img class="img-fluid" src="img/faqs-poster.png" alt="faqs">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                                       aria-expanded="true" aria-controls="collapseOne">
                                        ...
                                        1. How to setup your EWI account?
                                    </a>
                                </h4>
                            </div>
                                ...
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                       href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="more-less ti-plus"></i>
                                        2. What are workspaces and how to create them?
                                    </a>
                                </h4>
                            </div>
                                ...
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                       href="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
                                        <i class="more-less ti-plus"></i>
                                        5. How do you add a new product?
                                    </a>
                                </h4>
                            </div>
